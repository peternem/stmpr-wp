...
<div id="content" class="row">
	...
	<div class="col-md-8">
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
			  	...
			  	<div class="content">
			    	...
			    	<div class="return-detail">
						...
						<div class="return-opened"><b><?php echo $entry_opened; ?></b><br />
							...
							<textarea name="comment" style="max-width: 980px; width: 100%;" rows="6"><?php echo $comment; ?></textarea>
						</div>
			...
			<?php } else { ?>
				<div class="buttons">
				  <div class="left"><a href="<?php echo $back; ?>" class="btn btn-primary btn-sm"><?php echo $button_back; ?></a></div>
				  <div class="right">
				    <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary btn-sm" />
				  </div>
				</div>
