...
<div id="content" class="col-md-9"><?php echo $content_top; ?>
  ...
  <div class="category-info">
    <?php if ($thumb) { ?>
    <div class="image"><img class="img-thumbnail" src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /></div>
    <?php } ?>
    <?php if ($description) { ?>
  ...
  <div class="product-compare"><a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></div>
	<div class="product-list">
    	...
    	<div class="row">
      		...
      		<div class="image col-xs-12 col-sm-2 col-md-2"><a href="<?php echo $product['href']; ?>"><img class="img-thumbnail" src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
      		<?php } ?>
      		...
      		<div class="price col-xs-12 col-sm-2 col-md-2">
