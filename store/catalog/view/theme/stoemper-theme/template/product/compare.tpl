...
<div id="content"><?php echo $content_top; ?>
    ...
    <?php } ?>
  	...
  	<?php if ($products) { ?>
 	<div class="row">
		<div class="col-md-12 compare-container">
		  <table class="compare-info table">
		    ...
		    <tr>
		      <td></td>
		      <?php foreach ($products as $product) { ?>
		      <td><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-primary btn-sm" /></td>
		      <?php } ?>
		    </tr>
		    <tr>
		      <td></td>
		      <?php foreach ($products as $product) { ?>
		      <td class="remove"><a href="<?php echo $product['remove']; ?>" class="btn btn-primary btn-sm"><?php echo $button_remove; ?></a></td>
		      <?php } ?>
		    </tr>
		  </table> 
 		</div>
