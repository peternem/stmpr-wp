...
<?php include 'inc/sitewide-stoemperZilla-wp.php' ?>
	<header id="branding" role="banner">
        		 <div id="globalHeader"><!--<img src="../images/backgrounds/STOEMPER_header_img_left.jpg" alt="Stoemper loves crowds" class="headerImgLh" /><img src="../images/backgrounds/STOEMPER_header_img_right.jpg" alt="Stoemper loves crowds" class="headerImgRh"/>--></div>
