	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('stoemp-pg-temp');?>>
		...
		<div class="row bike-images">
			<div class="col-sm-8 col-md-8">
				<img src="/wp-content/uploads/2015/12/gb-twentytree-eddy-740x.jpg"  alt="The Stoemper Ronny" class="imageStyle img-responsive"/>
			</div>
		  	<div class="col-sm-4 col-md-4">
				<img src="/wp-content/uploads/2015/12/gn-twentytree-eddy-by-todd-640x.jpg"  alt="The Stoemper Ronny" class="imageStyle top img-responsive"/>
				<img src="/wp-content/uploads/2015/12/bg-twentytree-eddy-headtube-640x.jpg"  alt="The Stoemper Ronny" class="imageStyle bottom img-responsive"/>
			</div>
		</div>				
		...
		<div class="row bike-images">
			<div class="col-sm-6 col-md-6">
				<img class="imageStyle resp-top img-responsive" alt="The Stoemper Eddy" src="/wp-content/uploads/2015/12/gb-twentytree-eddy-bike-640x.jpg">
			</div>
			<div class="col-sm-6 col-md-6">
				<img class="imageStyle img-responsive" alt="The Stoemper Eddy" src="/wp-content/uploads/2015/12/gb-twentytree-eddy-fork-640x.jpg">
			</div>
		</div>
