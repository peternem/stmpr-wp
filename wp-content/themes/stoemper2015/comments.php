...
<div id="comments-list" class="row comments">
	<div class="col-md-12">
	...
	<div id="comments-nav-above" class="row comments-navigation">
		<div class=" col-md-12 paginated-comments-links"><?php paginate_comments_links(); ?></div>
	...
	<div id="comments-nav-below" class="row comments-navigation">
		<div class="col-md-12 paginated-comments-links"><?php paginate_comments_links(); ?></div>
	...
	<form id="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
		...
		<div id="form-section-author" class="form-section">
			...
			<div class="form-input">
				<input id="author" name="author" type="text" value="<?php echo $comment_author ?>" size="100" maxlength="20" tabindex="3" /></div>
		...
		<?php endif /* if ( $user_ID ) */ ?>
			...
			<div id="form-allowed-tags" class="form-section">
				<p><span><?php _e('You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes:<br/>', 'your-theme') ?></span> <code><?php echo allowed_tags(); ?></code></p>
			</div>
 
<?php do_action('comment_form', $post->ID); ?>
 
			<div class="form-submit"><input id="submit" class="btn btn-default" name="submit" type="submit" value="<?php _e('Post Comment', 'your-theme') ?>" tabindex="7" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
