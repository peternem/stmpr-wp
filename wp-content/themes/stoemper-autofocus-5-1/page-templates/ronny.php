...
<div id="content" class="inner-container">
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('stoemp-pg-temp');?>>
		...
		<div class="row bike-images">
				...
				<!-- https://placeholdit.imgix.net/~text?txtsize=33&txt=740%C3%97740&w=740&h=740 -->
					<img src="/wp-content/uploads/2015/11/benberden-tokyo-ronny-DSC07780-740x.jpg"  alt="The Stoemper Ronny" class="imageStyle img-responsive"/>
				</div>
			  	<div class="col-sm-4 col-md-4">
					<img src="/wp-content/uploads/2014/01/stoemper-instgrm-alu-rd-bike-fall-640x.jpg"  alt="The Stoemper Ronny" class="imageStyle top img-responsive"/>
					<img src="/wp-content/uploads/2015/11/stoemper-instgrm-motofish-frame.jpg"  alt="The Stoemper Ronny" class="imageStyle bottom img-responsive"/>
				</div>
		</div>
		...
		<div class="row bike-images">
			<div class="col-sm-6 col-md-6">
				<img class="imageStyle resp-top img-responsive" alt="The Stoemper Ronny" src="/wp-content/uploads/2015/11/motofish-ronny_MG_5507-640x.jpg">
			</div>
			<div class="col-sm-6 col-md-6">
