	...
	<div id="container">
		<div id="content" class="index bikes-bground">
			...
			<article id="post-<?php the_ID() ?>" <?php post_class('stoemp-pg-temp');?>>
				<header class="row">
					<div class="col-md-8">
					<h2 class="entry-title">index.php - <a href="<?php the_permalink() ?>" title="<?php printf(__('Permalink to %s', 'sandbox'), esc_html(get_the_title(), 1)) ?>" rel="bookmark"><?php the_title() ?></a></h2>
