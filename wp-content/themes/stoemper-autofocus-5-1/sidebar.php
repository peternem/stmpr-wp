	<div id="primary" class="sidebar col-sm-12 col-md-6">
		<ul class="xoxo">
...
<?php endif; // end primary sidebar widgets  ?>
	...
	<div id="secondary" class="sidebar col-sm-12 col-md-6">
...
<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar(2) ) : // begin  secondary sidebar widgets ?>
			...
			<li id="rss-links" class="widget">
				...
				<ul>
					<li><a href="<?php bloginfo('rss2_url') ?>" title="<?php echo esc_htmls(get_bloginfo('name'), 1) ?> <?php _e('Posts RSS feed', 'sandbox'); ?>" rel="alternate" type="application/rss+xml"><?php _e('All posts', 'sandbox') ?></a></li>
