<?php get_header() ?>
	...
	<div id="primary" class="site-content">
		<div id="content" role="main">
			...
			<div id="nav-above" class="nav-above navigation">
				<div class="nav-previous"><?php previous_post_link('%link', '<span class="meta-nav">&laquo;</span> Older Posts', 'sandbox') ?></div>
				<div class="nav-next"><?php next_post_link('%link', 'Newer Posts <span class="meta-nav">&raquo;</span>', 'sandbox') ?></div>
			</div>
