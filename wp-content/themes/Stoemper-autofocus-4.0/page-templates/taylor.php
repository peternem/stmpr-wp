			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class() ?> stoemp-pg-temp">
				...
				<div class="entry-content bikes">
					...
					<div class="slideshow">
						...
						<img src="<?php bloginfo("template_url"); ?>/img/taylor/taylor-road-steel-600x395.jpg"  alt="The Stoemper Taylor" class="imageStyleLeft"/>
						<img src="<?php bloginfo("template_url"); ?>/img/taylor/taylor-road-steel-ht-shop-190x356.jpg"  alt="The Stoemper Taylor" class="imageStyleUpperRh"/>
						<!-- <img src="<?php bloginfo("template_url"); ?>/img/eddy/twentytree-eddy-ftdisc-200x300.jpg"  alt="The Stoemper eddy" width="200" height="300"  class="imageStyleLowerRh"/>
						...
						<img src="<?php bloginfo("template_url"); ?>/img/eddy/twentytree-eddy-bike1-545x380.jpg"  alt="The Stoemper eddy" width="545" height="380" class="imageStyleLeft"/> -->
						 ...
						 <div class="caption">
							<em>The Stoemper Taylör</em>
						</div>
					</div>
										
					<div id="eddyGeoChart">
						<h3>TAYL&ouml;R ROAD BIKE GEOMETRY</h3>
<?php
$currentThemeUrl = get_template_directory_uri();
$xmlUrl = $currentThemeUrl.'/xml/rd-geometery.xml';
//echo $url = 'http://stoemper.com/wp-content/themes/Stoemper-autofocus-4.0/xml/cx-geometery.xml';
// load SimpleXML
...
?>
					...
					<div class="imageCenter">
						...
						<img class="imageStyle" alt="The Stoemper Eddy" src="<?php bloginfo("template_url"); ?>/img/taylor/mill-steopidbuildbikes-818x500.jpg">
						<div class="caption">
					...
					<div id="nav-above" class="navigation">
						<div class="nav-previous"><a href="/index.php/the-bikes/darrell/">&laquo; Darrell</a></div>
