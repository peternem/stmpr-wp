			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class() ?> stoemp-pg-temp">
				...
				<div class="entry-content bikes">
					...
					<div class="imageCenter">
						...
						<img src="<?php bloginfo("template_url"); ?>/img/eddy/twentytree-eddy-bike-600x380.jpg"  alt="The Stoemper eddy" width="600" height="380" class="imageStyleLeft"/>
						<img src="<?php bloginfo("template_url"); ?>/img/eddy/twentytree-eddy-200x300.jpg"  alt="The Stoemper eddy" width="200" height="300"  class="imageStyleUpperRh"/>
...
?>
					...
					<div class="imageCenter">
						...
						<img class="imageStyle" alt="The Stoemper Eddy" src="<?php bloginfo("template_url"); ?>/img/eddy/twentytree-eddy-cockpit-600x380.jpg">
						<div class="caption">
							<em> The Stoemper Eddy with the Singlespeed Option</em>
						</div>
					</div>
					
					<div id="nav-above" class="navigation">
						<div class="nav-previous"><a href="/index.php/the-bikes/ronny/">&laquo; Ronny</a></div>
