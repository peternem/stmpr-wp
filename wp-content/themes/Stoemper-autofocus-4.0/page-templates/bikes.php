			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class() ?> stoemp-pg-temp">
				...
				<div class="entry-content bikes">
					...
					<div class="slideshow">
						...
						<div class="bikeCategoryDiv"> <img src="<?php bloginfo('template_url'); ?>/img/angus/bike_page_category_track-355_img_01.jpg" alt="Stoemper Track Bikes" />
							<div class="rollOver">
								<p><a href="/index.php/the-bikes/angus/" target="_self">Angus</a> - A hand-made steel track race bike. Race proven performance and sexy looks.</p>
							</div>
						</div>
					</div>
