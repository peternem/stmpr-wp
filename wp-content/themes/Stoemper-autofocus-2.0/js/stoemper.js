...
//$(document).ready( function() {
	...
	jQuery(".GodZillaPulse img, #story img, #theBikes img, #craft img, #ordering img, #media img, #contact img, .bikeCategoryDiv img, .rolloverBtn img").each(function() {
	...
	jQuery(".GodZillaPulse, #story, #theBikes, #craft, #ordering,#media, #contact, .bikeCategoryDiv a, .rolloverBtn a").mouseover(function(){
	...
	// Handle mouseout
	jQuery(".GodZillaPulse, #story, #theBikes, #craft, #ordering, #media, #contact, .bikeCategoryDiv a, .rolloverBtn a").mouseout(function(){
		if (typeof(imgsrc) != 'undefined') {
