...
<?php if (have_posts()) : ?>
			...
			<div class="row comment-count">
				...
				<div class="col-md-6 entry-content">
					<form id="noresults-searchform" class="form-inline" role="form" method="get" action="<?php bloginfo('home') ?>">
						<div class="form-group">
							<input id="noresults-s"  class="form-control" style="width:200px;margin-right: 5px;" name="s" type="text" value="<?php echo wp_specialchars(stripslashes($_GET['s']), true) ?>" size="40" />
...
<?php while ( have_posts() ) : the_post(); ?>
			...
			<div id="post-<?php the_ID() ?>" class="row <?php sandbox_post_class() ?>">
