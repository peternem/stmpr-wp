	...
	<div id="container">
		<div id="content" class="index bikes-bground">
			...
			<article id="post-<?php the_ID() ?>" class=" <?php sandbox_post_class() ?>">
				<header class="row">
					<div class="col-md-8">
					<h2 class="entry-title">index.php - <a href="<?php the_permalink() ?>" title="<?php printf(__('Permalink to %s', 'sandbox'), wp_specialchars(get_the_title(), 1)) ?>" rel="bookmark"><?php the_title() ?></a></h2>
