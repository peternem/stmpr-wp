			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class() ?> stoemp-pg-temp">
				...
				<div class="row entry-content bikes slideshow">
					...
					<div class="col-sm-12 col-md-4">
						<img class="imageStyle img-responsive" alt="TThe Stoemper Torch" src="http://stoemper.com/images/73900005.jpg"/>
						<img class="imageStyle img-responsive" alt="The Stoemper Shop" src="http://stoemper.com/images/IMG_0742.jpg" />
						<img class="imageStyle img-responsive" alt="The Stoemper Shop" src="http://stoemper.com/images/IMG_0702-295x197.jpg" />
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12 col-md-12">
