			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class() ?> stoemp-pg-temp">
				...
				<div class="row slideshow">
					<div class="col-sm-12 col-md-8">
						<img src="<?php bloginfo("template_url"); ?>/img/angus/Angus_IMG_2471_670.jpg"  alt="The Stoemper Angus" class="imageStyle img-responsive"/>
					</div>
					<div class="col-sm-12 col-md-4">
						<img src="<?php bloginfo("template_url"); ?>/img/angus/Angus_IMG_2486_335.jpg"  alt="The Stoemper Darrell" class="imageStyle img-responsive"/>
						<img src="<?php bloginfo("template_url"); ?>/img/angus/Angus_IMG_2523_335.jpg"  alt="The Stoemper Darrell" class="imageStyle img-responsive"/>
					</div>
				</div>	
				<div class="row slideshow">
					<div class="col-sm-12 col-md-8">
						<img src="<?php bloginfo("template_url"); ?>/img/angus/stoemper_angus_six_day_670.jpg"  alt="The Stoemper Angus" class="imageStyle img-responsive"/>
					</div>
					<div class="col-sm-12 col-md-4">
						<img src="<?php bloginfo("template_url"); ?>/img/angus/Angus_Guy_East_victory_335.jpg"  alt="The Stoemper Darrell" class="imageStyle img-responsive"/>
						<img src="<?php bloginfo("template_url"); ?>/img/angus/Angus_Guy_East_warmup_335.jpg"  alt="The Stoemper Darrell" class="imageStyle img-responsive"/>
					</div>
				</div>			
				<!-- <div class="row">
					<div class="col-xs-12 col-md-12 geoChart">
				...
				<div id="nav-above" class="row navigation">
					<div class="nav-next col-sm-4 col-md-4"><a href="/index.php/the-bikes/">The Bikes &raquo;</a></div>
				</div>
				<div class="row">
