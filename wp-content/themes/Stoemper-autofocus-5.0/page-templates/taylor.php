			...
			<div id="post-<?php the_ID(); ?>" class="<?php sandbox_post_class() ?> stoemp-pg-temp">
				...
				<div class="row slideshow">
					<div class="slideshow">
						<div class="col-sm-12 col-md-8">
							<img src="<?php bloginfo("template_url"); ?>/img/taylor/taylor-road-steel-600x395.jpg"  alt="The Stoemper Taylor" class="imageStyle img-responsive"/>
						</div>
					  	<div class="col-sm-12 col-md-4">
							<img src="<?php bloginfo("template_url"); ?>/img/taylor/taylor-road-steel-ht-shop-190x356.jpg"  alt="The Stoemper Taylor" class="imageStyle img-responsive"/>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<img alt="The Stoemper Eddy" src="<?php bloginfo("template_url"); ?>/img/taylor/mill-steopidbuildbikes-818x500.jpg" class="imageStyle img-responsive" />	
					</div>
				</div>
